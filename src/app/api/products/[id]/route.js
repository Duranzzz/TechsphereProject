...
export async function GET(request, { params }) {
    ...
    try {
        let sql = `
            ...
            COALESCE((SELECT SUM(cantidad_disponible) FROM inventario WHERE producto_id = p.id ${ubicacion_id ? 'AND ubicacion_id = $2' : ''}), 0) as stock,
        ...
        if (ubicacion_id) queryParams.push(ubicacion_id);
